...
reference this inherited entry elsewhere in an OSCAL
...
implementation that a leveraging system is inheriting from a
leveraged system.
    ...
    def uuid(self):
        ...
        inherited entry elsewhere in an OSCAL document. A UUID should be
