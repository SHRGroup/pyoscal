...
reference this provided entry elsewhere in an OSCAL
...
statement implementation that can be provided to another
system leveraging this system.
    ...
    def uuid(self):
        ...
        provided entry elsewhere in an OSCAL document. A UUID should be
    ...
    def description(self):
        ...
        control or control statement implementation that can be provided to
